...
export const FRONTIER = [
  ...
  { id: 'home-dong-studio', vai: 'mvp', ten: 'HOME "Dòng Studio" — Hoà chốt v3 13/08: BENTO MỘT MÀN thay cuộn 2 trang, mỗi thẻ widget động + cử chỉ (tilt/kính/kéo-thả note/Tab/1-9/hover kem) + 3 widget sáng tạo (Đồng hồ ánh sáng · Ảnh đẹp tuần · Vật liệu của tuần); nội dung v2 giữ (card dự án+ngăn Nháp, sự kiện 1 nơi, tự ẩn). Đang dựng theo phiếu home-bento-v3', he: 'Workspace', dot: 5, trangThai: 'chua',
