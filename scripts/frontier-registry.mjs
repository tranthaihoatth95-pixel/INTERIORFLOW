...
export const FRONTIER = [
  ...
  { id: 'import-ghe-tu-hinh', vai: 'mvp', ten: 'IMPORT CẤU KIỆN TỪ ẢNH → 3D mesh CÓ THAM SỐ (Hoà giao 14/08, ảnh ghế bar gỗ+nhung+đồng): pipeline 4 bước — ①tách nền (furniture-extract sẵn) ②vision đọc tham số auto-define (kind/category/w-d-h ước theo chuẩn + vật liệu) → PHIẾU duyệt cờ inferred [ProposalSheet] ③image-to-3D qua fal (THÊM task model Trellis/Hunyuan — client chưa có, grep 0) ④gói .idfc kind furniture (geom3d glb + params + PBR) vào Thư viện, dùng ở chặng 3D — mặt tiền ĐẦU TIÊN của auto-define; mesh là ước-hình không phải mesh kỹ thuật, khai thật bằng cờ 3 nấc', he: 'TriTueDuAn', dot: 8, trangThai: 'chua',
