...
export const FRONTIER = [
  ...
  { id: 'home-dong-studio', vai: 'mvp', ten: 'HOME bento — v3 bị Hoà lật THEME SÁNG 13/08 (9 hộp rỗng khi dữ liệu mỏng · card vỡ tên+avatar lặp · ảnh tuần ăn seed giả trân · ô 01 biển trắng+gradient lạc · cung mặt trời vô hình · sáng thiếu phân tầng). v4 nguyên tắc mới: BENTO CO GIÃN THEO ĐỘ DÀY DỮ LIỆU — 3 nấc layout, trạng thái MỎNG phải đẹp nhất; seed cấm lên Home. Phiếu home-bento-v4', he: 'Workspace', dot: 5, trangThai: 'chua',
