...
export const FRONTIER = [
  ...
  { id: 'tao-viec-tu-day', vai: 'day', ten: 'Chiều ngược TaskContext: "Tạo việc từ đây" ở 2D/3D/Trình chiếu — việc sinh ra tự gắn stage+entityId', he: 'Workspace', dot: 2, trangThai: 'chua',
