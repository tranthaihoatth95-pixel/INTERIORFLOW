...
export const FRONTIER = [
  ...
  { id: 'home-dong-studio', vai: 'mvp', ten: 'HOME BENTO v3 (13/08 H1c: một màn 12×3 scrollH=viewport, 9 ô số Swiss 01-09; Đồng hồ ánh sáng giờ thật 2700K · MaterialSphere thật · Ảnh tuần · Tab-hold kính · kéo-thả note · 1-9; ô trống tự ẩn grid giãn — T hậu kiểm DOM app thật; tilt bỏ CÓ LÝ DO theo SPEC-HOVER một-hiệu-ứng; nợ: exploded axon ô chặng + carousel 3D tắt trong bentoBox vì đơn vị vw)', he: 'Workspace', dot: 5, trangThai: 'xong',
