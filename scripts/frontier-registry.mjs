...
export const FRONTIER = [
  ...
  { id: 'home-nav-lag', vai: 'do', ten: 'Điều hướng về Home bị lag (Hoà bắt khi duyệt mắt 13/08 — kèm chốt đổi nhãn "Về Thư viện dự án"→"Home" đã sửa ngay): nghi phạm HomeScreen import TĨNH cả dàn render-studio (ReactFlow·3D·modals) vào chunk route `/` — đo chunk trước/sau bằng số rồi mới sửa (dynamic import các panel/modal gated-by-state), không đổi hành vi', he: 'Workspace', dot: 7, trangThai: 'chua',
