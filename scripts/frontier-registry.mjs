...
export const FRONTIER = [
  ...
  { id: 'nc-nguyen-tac-toan-app', vai: 'day', ten: 'NC-2 BỘ NGUYÊN TẮC GIAO DIỆN IF cấp toàn app (Hoà giao 14/08: lướt 3 board Pinterest Bentran_tth + tool 3D/render + videocall-trong-workspace): cơ chế theo cấp app/stage/luồng + hệ nút·phím·ký hiệu + visual theo loại trình bày technical/mood/vật liệu-fur → NT-1..n trình Hoà duyệt thành CHUẨN trước khi mock', he: 'DocCore', dot: 7, trangThai: 'chua',
