...
export const FRONTIER = [
  ...
  { id: 'home-dong-studio', vai: 'mvp', ten: 'HOME "Dòng Studio" (v1 cf3b5ec bị Hoà lật "ko ổn" → v2 sửa 5 lỗi đo DOM: card DỰ ÁN + ngăn Nháp thu gọn · ẩn nút Lark chưa config · khử sự kiện lặp + timeAgo 1 nguồn · lưới tích luỹ ngưỡng tự ẩn — T hậu kiểm Chrome app thật 5/5 ĐẠT 13/08; nợ ghi trong báo cáo H1b: carousel/flatList mobile còn per-flow)', he: 'Workspace', dot: 5, trangThai: 'xong',
