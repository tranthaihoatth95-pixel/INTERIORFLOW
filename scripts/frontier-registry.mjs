...
export const FRONTIER = [
  ...
  { id: 'feature-contract-may', vai: 'day', ten: 'P5 FeatureContract máy hoá (Hoà gật 13/08 đêm): registry hợp đồng 4 câu (Đọc gì·Ghi gì·Để lại công thức gì·Ai ăn theo) máy-đọc + scripts/soi-contract.mjs 2 chiều — engine mất = regress, kho khai có-dây mà 0 caller = lệch, kho chờ-dây có caller = sổ quên; nạp đầu = 14 kho DOI-CHIEU-42-SPEC §1 KIỂM LẠI bằng grep + các engine 12-13/08', he: 'DocCore', dot: 7, trangThai: 'chua',
    bangChung: [{ file: 'scripts/soi-contract.mjs', mau: 'anTheo' }, { file: 'scripts/contract-registry.mjs', mau: 'anTheo' }] },
  { id: 'if-rna-v0', vai: 'mvp', ten: 'P6 IF-RNA v0 — Hệ Thuộc Tính Tự Mô Tả, proof trên MaterialPbr (Hoà gật 13/08 đêm): 14 thuộc tính glTF thêm metadata (label VI/EN·đơn vị·min/max·lan truyền) → panel vật liệu TỰ SINH từ định nghĩa; đo bằng số dòng UI giảm + sửa-1-chỗ-lan-mọi-nơi; thành công mới nhân ra BuildOp/.idfc — KHÔNG RNA-hoá cả app một đợt (BAN-THIET-KE §4 bậc 2)', he: 'DocCore', dot: 7, trangThai: 'chua',
