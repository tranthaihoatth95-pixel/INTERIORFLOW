...
export const FRONTIER = [
  ...
  { id: 'chuan-net-3d', vai: 'mvp', ten: 'BƯỚC CHUẨN NÉT cho mesh máy sinh (Hoà đặt 14/08 sau khi GLB vào 3ds Max lỗi — bóng đổ bị nướng thành khối mesh): ①tách connected-components + phát hiện/xoá shadow-blob (mảnh phẳng sát đất màu tối) ②QUY VỀ HÌNH HỌC HÀM SỐ — fit primitive có tham số: vòng đồng=torus, chân=cylinder/lathe, gác chân=torus/sweep — REBUILD qua kho 9 hàm build-ops sẵn (khối chính xác, chỉnh bằng tham số) ③phần hữu cơ (nệm) giữ mesh làm sạch + poly budget dễ điều chỉnh ④xuất FBX/OBJ cho 3ds Max (KHAI THẬT: .max là format đóng chỉ Max ghi được — đường chuẩn là FBX/OBJ import) — proof trên lincoln-327.glb, 0 job AI', he: 'TriTueDuAn', dot: 8, trangThai: 'chua',
