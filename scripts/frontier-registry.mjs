...
export const FRONTIER = [
  ...
  { id: 'home-dong-studio', vai: 'mvp', ten: 'HOME "Dòng Studio" — v1 (cf3b5ec) BỊ HOÀ LẬT 13/08 "ko ổn", T đo DOM ra 5 lỗi: mặt tiền vẫn 16 card flow rác chưa gom ngăn Nháp · nút Lark bệnh còn · card nghèo chip/quy mô · 1 sự kiện lặp 3 widget mâu thuẫn thời gian · lưới tích luỹ 16 hoạt động vẫn hiện (trái luật tự ẩn). v2 đang sửa theo phiếu home-dong-studio-v2', he: 'Workspace', dot: 5, trangThai: 'chua',
