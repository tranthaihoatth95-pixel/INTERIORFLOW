...
export const FRONTIER = [
  ...
  { id: 'hieu-nang-do', ten: 'ĐO hiệu năng có số (trụ 7 đói — cảnh báo 12/08): bản vẽ 5.000 entity · scene 100k tam giác · kệ 1.500 ảnh ảo hoá — đo trước Cửa B, ra bảng số + điểm gãy', he: 'DocCore', dot: 2, trangThai: 'chua',
    bangChung: [{ dir: 'docs/bao-cao-phien', mau: 'hieu-nang-do|benchmark-if' }] },
  { id: 'focus-entity-doc', ten: 'Các chặng ĐỌC ?focusEntity từ deep-link TaskContext: 2D select đúng đối tượng, 3D chọn đúng khối (khép vòng bấm-việc-rơi-đúng-chỗ Phiếu 1)', he: 'Workspace', dot: 2, trangThai: 'chua',
    bangChung: [{ dir: 'components', mau: 'focusEntity' }] },
  { id: 'tao-viec-tu-day', ten: 'Chiều ngược TaskContext: "Tạo việc từ đây" ở 2D/3D/Trình chiếu — việc sinh ra tự gắn stage+entityId', he: 'Workspace', dot: 2, trangThai: 'chua',
    bangChung: [{ dir: 'components', mau: 'taoViecTuDay|createTaskFromContext' }] },
  { id: 'camera-pro', ten: 'Camera mức nghề (2 điểm tụ · tiêu cự mm · DOF · safe frame · tỉ lệ khung — chốt 03/08 "rất cần cho góc nhìn/view/video"): thay tab Camera placeholder', he: 'BuildRecipe', dot: 2, trangThai: 'chua',
  ...
  { id: 'vitals-3-window', ten: 'Vitals 3 cấp window theo Siri mới (ref #14): ① pill/thẻ kết quả tại chỗ ② thẻ hội thoại nổi ③ trang phiên đầy đủ — kèm nấc giảm chói kính', he: 'ThinkDial', dot: 2, trangThai: 'chua',
    bangChung: [{ dir: 'components', mau: 'VitalsWindowTier|vitals-tier' }] },
  { id: 'hover-gradient-kem', ten: 'Highlight gradient kem khi hover/select (ref #15) trên canvas tone be/xám-đen — chỉ phần tử chọn được, reduce-motion tức thì', he: 'LightState', dot: 2, trangThai: 'chua',
