/**
 * lib/present-editor/luu-len-may-chu.ts — SAO LƯU DECK LÊN MÁY CHỦ.
 *
 * VÌ SAO CÓ: một deck 24 trang MẤT trắng khi hồ sơ trình duyệt bị làm mới. Đo tại nguồn thì hiểu
...
export async function saoLuuDeckLenMayChu(
  ...
  /**
   * ⛔ CHẶN GHI ĐÈ BẰNG BẢN RỖNG — lỗi THẬT đã tự gây ra rồi bắt được: nhịp sao lưu định kỳ chạy
