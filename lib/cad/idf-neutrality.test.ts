/**
 * lib/cad/idf-neutrality.test.ts — Test cưỡng chế LUẬT TRUNG TÍNH (Luật #13, docs/IF-FEATURE-TREE.md
 * PHẦN E, chốt 30/07). Rationale (Hoà): "luật không có test thì 3 tuần là
...
const EXEMPTIONS: Exemption[] = [
  ...
  },
  {
    ...
    reason:
      ...
      'XEM LẠI khi làm preflight-theo-đích — nét khi in theo từng đích là việc của ĐÍCH (miễn trừ này YẾU NHẤT trong danh sách, Hoà chốt 30/07: ACI color-dependent plot style vốn có phần là ánh xạ trình bày, không thuần hình học như Pt.x/y).',
  },
  {
    file: 'model.ts',
    typeName: 'Base',
    key: 'color',
    reason: 'Override màu layer per-entity (hiếm dùng) — cùng cơ chế/lý do với Layer.color ở trên, kể cả phần "XEM LẠI khi làm preflight-theo-đích".',
  },
  {
    file: 'model.ts',
    typeName: 'RectEntity',
