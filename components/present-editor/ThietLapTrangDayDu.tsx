...
export default function ThietLapTrangDayDu({
  ...
  useEffect(() => {
    ...
    // đang ở trong một ô nhập của biểu mẫu, nên KHÔNG bail theo INPUT/TEXTAREA ở đây.
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 300px', minHeight: 0 }}>
        ...
        >
          ...
          <NumSau nhan="Chế độ độ dày nét" ly={khaNang.bangNetIn} onClick={onMoBangNet} icon={<Ruler size={16} />} />
