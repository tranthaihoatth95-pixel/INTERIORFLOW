    ...
    >
      ...
      <div className="space-y-1.5 p-2.5">
        ...
        <div className="flex gap-1.5">
          <input
            className="min-w-0 flex-1 rounded-[10px] border border-[var(--border)] bg-[var(--field)] px-2.5 py-1.5 text-xs text-[var(--t1)] placeholder-[var(--t5)] transition-colors focus:border-[var(--focus-ring)]"
            ...
            {addOpen && (
              <div className="absolute right-0 top-full z-30 mt-1.5 w-64 space-y-1.5 rounded-[10px] border border-[var(--border)] bg-[var(--card)] p-2.5 shadow-lg">
                <select
                  ...
                  className="w-full rounded-[10px] border border-[var(--border)] bg-[var(--field)] px-2.5 py-1.5 text-xs text-[var(--t1)] transition-colors focus:border-[var(--focus-ring)]"
                >
                ...
                <input
                  className="w-full rounded-[10px] border border-[var(--border)] bg-[var(--field)] px-2.5 py-1.5 text-xs text-[var(--t1)] placeholder-[var(--t5)] transition-colors focus:border-[var(--focus-ring)]"
