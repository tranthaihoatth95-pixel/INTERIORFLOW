...
export function BottomToolbar({ onAddNote }: { onAddNote: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="if-bottombar mat-card no-scrollbar pointer-events-auto absolute bottom-3 left-1/2 z-20 flex max-w-[calc(100%-1.5rem)] items-center gap-[5px] overflow-x-auto border border-[var(--mat-hairline)] shadow-[0_8px_24px_rgba(40,38,35,.14)]"
