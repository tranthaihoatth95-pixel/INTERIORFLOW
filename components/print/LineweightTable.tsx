...
export default function LineweightTable({ rows = DEMO_LINEWEIGHT_ROWS }: Props) {
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', minHeight: 0, fontFamily: FONT }}>
      <div style={{ padding: '12px 12px 10px', borderBottom: '1px solid var(--vien-mo)' }}>
      ...
      <div style={{ padding: '10px 12px', borderTop: '1px solid var(--vien-mo)', display: 'flex', flexDirection: 'column', gap: 8 }}>
