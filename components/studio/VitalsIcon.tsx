...
/**
 * components/studio/VitalsIcon.tsx — glyph riêng của Vitals AI (thay Lucide `Sparkles`).
 *
 * Hình: GIỌT NƯỚC cách điệu — nói tiếp ngôn ngữ "giọt kính lỏng" đã dùng ở StageSwitcher
 * (kéo tab xuống → giọt Vitals mọc ra). Bên trong giọt có chữ V (Vitals) đọc thoáng, không hét.
 *
...
export default function VitalsIcon({ size = 16, strokeWidth = 1.5, ...rest }: VitalsIconProps) {
  return (
    <svg
    ...
    >
      ...
      {/* Chữ V mảnh bên trong — dấu chỉ Vitals, không hét */}
