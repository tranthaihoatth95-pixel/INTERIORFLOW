...
export function InspectorPages({ pages }: { pages: InspectorPage[] }) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      {pages.length > 1 && (
        <div className="flex h-[34px] shrink-0 items-center gap-0.5 border-b border-[var(--mat-hairline)] px-1.5">
          {pages.map((p) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'grid h-[26px] w-[30px] place-items-center rounded-[8px] transition-colors duration-[120ms]',
