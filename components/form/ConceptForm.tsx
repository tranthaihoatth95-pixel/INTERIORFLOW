      ...
      <StepCard n={4} title="Nội dung & phong cách">
        <Field label="Tiêu đề" hint="để trống = mặc định theo dạng">
          <input
            ...
            className="w-full rounded-[14px] border border-[var(--border)] bg-[var(--field)] px-3 py-3 text-[14px] text-[var(--t1)] placeholder:text-[var(--t5)] focus:border-[var(--focus-ring)]"
          />
        </Field>
          ...
          <div className="mt-3">
            ...
            >
              <textarea
                ...
                className="w-full resize-none rounded-[14px] border border-[var(--border)] bg-[var(--field)] px-3 py-3 text-[14px] text-[var(--t1)] placeholder:text-[var(--t5)] focus:border-[var(--focus-ring)]"
              />
            </Field>
          </div>
        )}
