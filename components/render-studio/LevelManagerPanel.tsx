          ...
          {levels.map((level, i) => (
            ...
            >
              ...
              <input
                ...
                className="h-[var(--row)] min-w-0 flex-1 rounded-[6px] border border-transparent bg-transparent px-1 text-[11.5px] leading-[1.6] text-[var(--t2)] transition-colors hover:border-[var(--border)] focus:border-[var(--focus-ring)] focus:bg-[var(--field)] focus:outline-none"
              />
        ...
        <div className="mt-2 rounded-[10px] border border-[var(--border)] bg-[var(--field)] px-2 py-1.5">
          ...
          {levels.length === 0 ? (
            ...
            <select
              ...
              className="mt-1 h-[var(--tap)] w-full rounded-[10px] border border-[var(--border)] bg-[var(--panel)] px-1.5 text-[11px] leading-[1.6] text-[var(--t1)] focus:border-[var(--focus-ring)] focus:outline-none"
            >
