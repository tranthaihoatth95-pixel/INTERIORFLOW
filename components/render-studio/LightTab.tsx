          ...
          <>
            ...
            <label className="block">
              ...
              <input
                ...
                className="mt-0.5 h-[var(--tap)] w-full rounded-[6px] border border-[var(--border)] bg-[var(--panel)] px-1.5 text-[11px] leading-[1.6] text-[var(--t1)] focus-visible:border-[var(--accent)]"
              />
            </label>
            <p className="text-[9.5px] leading-relaxed text-[var(--t5)]">
              {tr(
