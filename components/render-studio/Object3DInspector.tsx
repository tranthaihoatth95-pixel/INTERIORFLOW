...
export function Object3DInspector() {
  ...
  return (
    ...
    <div className="space-y-3 p-3">
      {/* mock `.ihead`: viền dưới `--vien-mo` tách tên/mã khỏi phần thân cuộn — trước không có. */}
      ...
      <p className="border-t border-[var(--vien-mo)] pt-2.5 text-[10px] leading-relaxed text-[var(--t5)]">
        {kind === 'wall'
  ...
  return (
    <label className="block rounded-[10px] border border-[var(--border)] bg-[var(--field)] px-2.5 py-1.5">
      ...
      <select
        ...
        className="mt-0.5 h-[var(--tap)] w-full rounded-[10px] border border-[var(--border)] bg-[var(--panel)] px-1.5 text-[11px] leading-[1.6] text-[var(--t1)] focus:border-[var(--focus-ring)] focus:outline-none"
      >
