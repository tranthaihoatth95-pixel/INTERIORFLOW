  ...
  return (
    <span className={cn('relative inline-flex w-full items-center', className)}>
      <input
        ...
        className={cn(
          'h-[var(--tap)] w-full rounded-[6px] border border-[var(--border)] bg-[var(--field)] text-right font-mono text-[11px] leading-[1.6] text-[var(--t1)] focus:border-[var(--focus-ring)] disabled:opacity-45',
