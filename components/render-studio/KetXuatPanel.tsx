          ...
          >
            ...
            {loiJob && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                ...
                >
                  <RotateCw size={12} /> {tr('Thử lại', 'Retry')}
                </button>
              </div>
            )}
                  ...
                  <>
                    {bg.loai === 'anh' && (
                      <button
                        ...
                        style={btnPhu}
                      >
                        <Clapperboard size={12} /> {tr('Chuyển động', 'Motion')}
                      </button>
                    )}
                    {bg.loai === 'anh' && (
                      <button type="button" onClick={() => sangTrinhChieu(bg)} style={btnPhu}>
                        <ExternalLink size={12} /> {tr('Sang Trình chiếu', 'To Presenting')}
                      </button>
                    )}
                    {bg.loai === 'phim' && (
