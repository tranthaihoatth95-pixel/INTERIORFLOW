...
export default function DrawToolbar() {
  ...
  return (
    <motion.div
      ...
      className="nen-mo-card pointer-events-auto absolute left-3 top-1/2 z-20 flex -translate-y-1/2 flex-col gap-1.5 rounded-full border border-[var(--vien-mo)] p-2 shadow-[0_8px_24px_rgba(40,38,35,.14)]"
    >
