...
function HairBack({ hair, fill, shade }: { hair: AvatarConfig['hair']; fill: string; shade: string }) {
  switch (hair) {
    case 4: // dài thẳng
      return (
        <path
          d="M16 220 Q10 80 100 27 Q190 80 184 220 L152 220 Q160 138 154 98 Q144 60 100 56 Q56 60 46 98 Q40 138 48 220 Z"
          fill={fill}
        />
      );
    case 5: // bob ngang cằm
      return (
        <path
          d="M18 156 Q12 74 100 28 Q188 74 182 156 Q174 174 150 164 Q160 120 152 94 Q142 58 100 54 Q58 58 48 94 Q40 120 50 164 Q26 174 18 156 Z"
          fill={fill}
        />
      );
    case 9: // bob ngang vai, cụp vào trong (dáng ref)
      return (
        <path
          d="M18 182 Q12 76 100 27 Q188 76 182 182 Q172 202 146 186 Q160 134 152 96 Q142 58 100 54 Q58 58 48 96 Q40 134 54 186 Q28 202 18 182 Z"
          fill={fill}
        />
      );
    case 10: // dài gợn sóng
      return (
        <>
          <path
            d="M14 220 Q6 80 100 27 Q194 80 186 220 L154 220 Q172 184 158 158 Q172 126 152 96 Q142 58 100 54 Q58 58 48 96 Q28 126 42 158 Q28 184 46 220 Z"
            fill={fill}
          />
    ...
    case 12: // đuôi ngựa lệch phải
      return (
        <>
          <path
            d="M24 148 Q18 74 100 28 Q182 74 176 148 Q164 106 152 94 Q126 58 100 56 Q74 56 48 94 Q36 106 24 148 Z"
            fill={fill}
          />
    ...
    case 15: // hime — hai lọn dài hai bên
      return (
        <path
          d="M16 220 Q10 78 100 27 Q190 78 184 220 L152 220 Q158 138 152 96 Q142 58 100 54 Q58 58 48 96 Q42 138 48 220 Z"
          fill={fill}
        />
      );
    default:
