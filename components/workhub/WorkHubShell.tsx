 ...
 *
 * ⚙️ IF-WORKHUB-CONTAINMENT-001 (27/08, hoà từ nhánh `checkpoint`) — BA điều kèm theo, giữ trọn:
 *   ⓐ **Nhúng miền NGOÀI phải sau cờ riêng, mặc định TẮT** (`lib/workhub/cong.ts`). Cờ tắt thì ô
 *      địa chỉ không nhúng được gì, kể cả URL gõ tay.
 *   ⓑ **Không nhúng tên riêng.** Bản rất cũ chào `'Chào Hoa. …'` — nhúng cứng tên một người vào
 *      sản phẩm, trái LUẬT NỀN TẢNG (IF trung tính, toàn cầu). Câu đó nay không còn vì cả ngăn
 *      trợ lý đã gỡ; ghi lại để không ai dựng lại một lời chào có tên.
 *   ⓒ **Không đóng băng ngày.** Bản trước ghi cứng `'Thứ Hai, 17 tháng 8'` ngay cạnh chữ "Không
 *      gian làm việc" — app nói dối về thời gian thực, và đó là dấu vết một lần chụp màn hình bị
 *      bỏ quên trong mã. Nay đọc ngày thật theo ngôn ngữ đang chọn.
 */
