 ...
 * icon điều hướng/lệnh phải ĐỌC TỪ ĐÂY, cấm gõ `size={16}` `strokeWidth={1.5}` tại chỗ dùng —
 ...
 *
 * ⛔ `net` KHÔNG được vượt 1,75. Trước 20/08 rail dùng `strokeWidth={1.5}` cho mục đang mở: nét 2
