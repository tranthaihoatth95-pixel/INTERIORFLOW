...
- **CÒN LẠI (autonomous phiên sau)**: merge nốt video-nodes + pwa; restyle nốt Apple (InteriorNode/MaskPainter/Lightbox/BottomToolbar/FlowCanvas); (tuỳ chọn) wire empty-state canvas nạp starter theo chặng (`phase.demo`).
