...
| **0y** | `docs/control/IF-FORM-TRA-LOI.md` | **CÁCH TRẢ LỜI** — kết luận trước · nhãn `FACT/INFERENCE/PROPOSAL/UNKNOWN` · **cấm nói "xong/PASS/an toàn" khi chưa có biên nhận** · không hỏi A/B khi tự chọn được · **20–60 giây**. Hoà đưa trực tiếp 30/08, dùng chung với tuyến Codex | **luôn luôn** |
| **0z** | `docs/control/ban/<NN>.md` | **BÀN CỦA LANE BẠN ĐANG NGỒI** — vai · cấm · bài học đã trả giá · nghiệm thu · việc đang dở. Hoà chốt 30/08: *"agent phiên chỉ là người ngồi bàn; người này hết lượt đi ra thì người khác thay. **Kiến thức, quy định nằm tại BÀN kèm chỉ dẫn** — ngồi vào đọc nhanh là nhận bàn giao làm tốt ngay, chứ không quên quên nhớ nhớ."* Đây đúng kiến trúc IF áp lên chính chúng ta: `Workspace nhớ · Canvas là bề mặt · người đến rồi đi` | **ngay khi ngồi vào một lane** |
...
| **0e** | `docs/GU-PROFILE.md` | **GU CỦA HOÀ ĐÃ CHƯNG CẤT** — 49 dòng, học từ **4 board Pinterest** (`pinterest.com/Bentran_tth`, ~1.500+ pin, cluster k-means 11/07). §1 gu render nội thất · **§2 gu GIAO DIỆN APP** (*liquid-glass / soft neumorphism · pill bo full · frosted blur · **đơn sắc + 1 accent** · toolbar nổi · typography lớn sạch · **KHÔNG rẽ flat/material***) · §3 gu slide. ⚠️ **Tệp này TỪNG KHÔNG AI TRỎ TỚI** — đo 30/08: 0 con trỏ từ `CLAUDE.md`/`docs/control/`/`.claude/`, chỉ 5 tài liệu sâu nhắc tên. Hậu quả Hoà nói thẳng 30/08: *"việc này làm đi làm lại hoài chán luôn, đã từng có phiên nó chưng cất rồi"* — mỗi phiên tự suy lại gu từ đầu, tức N8 ở dạng nặng nhất. Bản mock kèm theo: artifact **`InteriorFlow · Bộ màn thiết kế`** (26/08, 44 màn `.dc.html`) — ⚠️ **CHỈ dùng cho NGÔN NGỮ THỊ GIÁC**, Hoà chấm 30/08: *thẩm mỹ đúng ~**65%***, còn *"**nội dung theo router thì không cái nào đúng**"* — **ngoại lệ duy nhất: màn Home "còn đúng 1 chút"**. Lấy nó làm đặc tả nội dung là sai gần như toàn bộ | **trước mọi việc chạm mặt nhìn** |
...
| **2b** | `docs/control/IF-CHUAN-NEN.md` | **CHUẨN NỀN ĐO ĐƯỢC** — tương phản WCAG 2.2 AA · thang mô-đun · sàn chữ Việt V-1/2/3/6 · đơn sắc + 1 accent, **kèm nguồn nghiên cứu**. Hoà chốt 30/08: *"chuẩn là những thứ đã được nghiên cứu và ứng dụng rồi… không có lý do gì trông chờ vào tôi cả"* ⇒ **mắt Hoà chỉ chấm CÁ TÍNH**, mọi thứ đo được thì máy chấm. Đo 30/08: thang chữ và thang bo của IF **không phải thang mô-đun** | **trước mọi việc chạm mặt nhìn** |
