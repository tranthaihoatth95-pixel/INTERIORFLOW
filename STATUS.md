# STATUS — InteriorFlow (13/08 tối)

## MỞ PHIÊN MỚI: dán câu lệnh §5 HOP-DONG-PHOI-HOP-T + `npm run soi:frontier`. Đọc thêm: TRIET-LY-IF.md (hiến pháp, TRÍCH MÃ ĐIỀU KHOẢN vào mọi phiếu) · 00-CHOT 2 dòng cuối. Nhịp chuỗi nền: ~~P3~~ ✅ → **P4 Gói-Hồ-Sơ-Sống** (entry `goi-ho-so-song` mở) → P5 FeatureContract-máy → P6 IF-RNA-v0 (chờ Hoà gật P5-P6; mỗi phiên 1 món + ≥1 món nhìn-thấy song song). Món nhìn-thấy sẵn hàng: sửa 5 lệch soi:thao-tac (nhóm theo tội danh) · GR v1 bảng ánh xạ.

## Chờ tay HOÀ (xếp hàng)
1. Duyệt phác Home v5 (mock đã gửi chat, SPEC-HOME-BENTO-V5) 2. Chọn ảnh render ST5 → T upscale 300dpi 3. Lô duyệt mắt #1+#2 (nợ mắt 47) 4. Gật lộ trình P5-P6. (Video/tool-3-lớp ĐÃ PHÁN 13/08 — entry kien-truc-tool-3-lop + dan-y-cho-san mở.)
