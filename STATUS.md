...
- **19/07 khuya — ĐỢT MỚI user giao:**
  ...
  - ⏳ **Nhúng font thật vào PPTX** — user yêu cầu làm thêm; agent đang chạy (`feat/pptx-font-embed`), phải khảo sát tính khả thi trước (pptxgenjs nhiều khả năng không có API nhúng; có thể phải hậu xử lý zip + kiểm cờ bản quyền `fsType`).
