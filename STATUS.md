...
- **Mock 3D Library:** type/instance → tool → FlowRender → ảnh/BOQ/board; vách–trần–sàn–đồ rời–đèn. Mock + spec: `docs/mocks/mock-3d-library-flowrender-2026-08-11.html`, `docs/SPEC-FLOWRENDER-ELEMENT-TOOLS-2026-08-11.md`.
