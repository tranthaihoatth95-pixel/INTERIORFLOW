...
- **Mock 3D Library:** type/instance → editor theo tác vụ → FlowRender → ảnh/BOQ/board; vách–trần–sàn–đồ rời–đèn. Mock + spec: `docs/mocks/mock-3d-library-flowrender-2026-08-11.html`, `docs/SPEC-FLOWRENDER-ELEMENT-TOOLS-2026-08-11.md`.
