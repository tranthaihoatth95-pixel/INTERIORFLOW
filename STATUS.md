...
- **21/07 (worktree riêng) — Gallery "ambient cover glow"** (nhánh `feat/gallery-ambient-cover-bg`, rebase lên M1 Larkbase, **CHƯA merge**, `80d722d`): nền Gallery đổi theo ảnh bìa card focus (carousel only), z dưới quầng đồng. Verify OK, không đè Larkbase.
