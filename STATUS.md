...
1. **ĐI LÔ DUYỆT MẮT #1** — `docs/duyet-mat/LO-1-2026-08-13.md`: 49 mục gộp 7 trạm ~20 phút, trả lời "Trạm N ok/lệch" là T flip loạt 2. Duyệt phác Home v5 (SPEC-HOME-BENTO-V5) 3. Chọn ảnh render ST5 → T upscale 300dpi 4. Gật lộ trình P5-P6. (Preview Gói Hồ Sơ Sống + .zip mẫu đã gửi trong chat.)
...
- **13/08 đêm (đợt T #2 · 2 agent song song):** ⭐**P4 Gói Hồ Sơ Sống v0 XONG** — `.zip` 3 tầng thoái lui (viewer HTML tự chứa 0-mạng-ngoài · file chuẩn ngành `out/` · ruột JSON + manifest sha256); điểm cắm Toolbar Trình chiếu; 22 test; gói mẫu T mở mắt đạt, preview gửi Hoà. **Sửa lệch soi:thao-tac đợt 1** — 41 chỗ 3 luật cơ khí (Webkit prefix · keydown né ô nhập + chuẩn hoá esc-only · 16 nhãn "tự động" đổi đúng nghĩa); còn 7 chỗ present-editor nhường + 2 hàng đợi mắt-design. **LÔ DUYỆT MẮT #1 đã soạn** (`docs/duyet-mat/LO-1`): 49 mục → 7 trạm ~20'. Nợ khai thật: kênh PDF gói chờ export.ts trả Blob.
