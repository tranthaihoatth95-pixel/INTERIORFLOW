...
| [`SPEC-FILE-MANAGER.md`](SPEC-FILE-MANAGER.md) | File Manager toàn app — [CẦN HOÀ DUYỆT]. |
| [`SPEC-IF-LIBRARY.md`](SPEC-IF-LIBRARY.md) | IF Library (siêu thư viện tài sản/DAM) — [CẦN HOÀ DUYỆT]. |
| [`SPEC-KNOWLEDGE-BASE.md`](SPEC-KNOWLEDGE-BASE.md) | Kệ sách & tri thức (T5) — [CẦN HOÀ DUYỆT]. |
| [`SPEC-MATERIAL-PIPELINE.md`](SPEC-MATERIAL-PIPELINE.md) | Chuỗi vật liệu — [CẦN HOÀ DUYỆT]. |
| [`SPEC-PRESENT-FLOW.md`](SPEC-PRESENT-FLOW.md) | Present Flow & Video (chặng 3) — [CẦN HOÀ DUYỆT]. |
