...
| 4.1.d | ĐỢT B — B4 ⚠️ PHA RỦI RO NHẤT: đảo nguồn sự thật (tệp thật thành nguồn, IndexedDB tụt xuống cache) + di trú dữ liệu cũ | N | ⬜ chưa làm — BẮT BUỘC trình bày kế hoạch di trú riêng, chờ gật riêng cho pha này (khác các pha khác) | 4.1.c | `docs/QUYET-DINH-HA-TANG-2026-07-31.md` ⑥ |
