...
| Nguồn | Nội dung | TT |
|---|---|---|
| **⚠️ CHƯA CÓ FILE** | **Spec Vitals AI v0.1 (MIA soạn 24/07)** — 6 nhóm tính năng: Ambient orb → canvas copilot → grounded citation → **function-calling tạo/sửa node** → multimodal (voice+ảnh) → audio overview. Hiện chỉ nằm trong chat, **cần lưu thành `docs/SPEC-VITALS-AI.md`** | 🔴 nợ |
...
- **Nợ tài liệu 🔴**: spec Vitals AI chưa được lưu thành file — cần tạo `docs/SPEC-VITALS-AI.md` trước khi code, nếu không mất khi chuyển phiên.
