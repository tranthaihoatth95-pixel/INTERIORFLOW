<!--
================================================================================
 IF - DESIGN AUTHORITY SPEC - NHAP VAO REPO 26/08/2026
 task IDF-BUILDER-OS-CLAUDE-BOOTSTRAP-001 - P0A

 status:           CANDIDATE
 authority_owner:  IF UX/UI - Design Authority (phien Codex "10")
 imported_by:      CLAUDE MAIN - interiorflow-65 (production writer lease)
 generated_at:     2026-08-24 (phien Codex) - nhap 2026-08-26
 source:           ~/.codex/visualizations/2026/08/24/01a031aa-.../IF-FINAL-DESIGN-CONTRACT-CANDIDATE.md
 sha256_thuc_te:   30e2a99edaf01f6319558743767b999dca7666827ab333dae7b88cdb793ca91b
 sha256_ky_vong:   9d353dd409f5be455be77d71662a0933eb5f1333794866a681666a45b6c10e14
 hash_khop:        KHONG - Design Authority da cap nhat tep sau khi ghi hash ky vong.
                   Nhap BAN HIEN TAI dung chi thi ("khong dung expected hash cu de ghi
                   de file moi"). Hash ky vong giu lam dau vet, KHONG dung de phan.
 supersedes:       -
 superseded_by:    -
 review_pointer:   docs/mocks/CLAUDE-DESIGN-CURRENT.md

 VI SAO PHAI CUU TEP NAY VAO REPO
 Truoc luot nhap nay, toan bo spec UX/UI (da toi ban 027) CHI SONG trong mot link chat
 155.831 ky tu va mot thu muc tam cua Codex. `find` toan repo lan Drive = 0 ket qua.
 IF-CANONICAL cam lay chat lam nguon su that; link muc nat la mat trang khoi spec lon
 hon moi thu lam trong ba ngay. Day chinh la lo do, va day la luot va.

 CANDIDATE - CHUA APPROVED. Chi Hoa nang duoc. Khong thi cong thang tu tep nay ma
 chua qua Design Contract + packet cua Codex MAIN.
 Quet truoc khi nhap: 0 secret, 0 token, 0 duong dan may ca nhan, 0 email/PII.
 Hai cho nhac "TTT" deu la CAU BAT BUOC TRUNG TINH ("no TTT/client hardcode",
 "not a customer, TTT or fixture asset"), khong phai nhiem du lieu khach.
================================================================================
-->
