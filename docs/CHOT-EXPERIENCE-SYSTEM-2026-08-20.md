...
- AI sinh bố cục → **Layout Ghost / Auto Grid Skeleton**: dựng CẤU TRÚC trước rồi đổ nội dung — user thấy hệ thống đang tổ chức, không random (khớp Magic/GenerateFlow + luật human-in-loop).
  ⚠️ **ĐÍNH CHÍNH SCOPE (Hoà 20/08, sau bản chốt này)**: Auto Grid là **capability authoring CỦA
  PRESENT** (compose block trên Present canvas), KHÔNG phải framework auto-layout toàn app;
  Layout Ghost là motion của capability đó. Board EXS-J v2 là bản đúng; EXS-K (5 ca) đã huỷ.
