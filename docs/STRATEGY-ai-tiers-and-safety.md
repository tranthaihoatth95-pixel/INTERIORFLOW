...
**RẤT NÊN — và đây là tính năng 0-AI, giá trị cao, đúng tinh thần an toàn.** Ý tưởng: **Material Tag / Bảng vật liệu**:
- Trên ảnh render (từ AI *hoặc* từ Vray/D5), click 1 điểm → chọn vật liệu từ **thư viện** (mã An Cường, texture) → app đặt **callout đánh số** (①②③) lên đúng vị trí.
- Tự sinh **bảng chú thích (legend/material schedule)** bên cạnh: số → ảnh swatch + tên + mã NCC.
- Xuất kèm ảnh/board — ra đúng "bản spec vật liệu" mà khách + xưởng thi công cần.
