...
```
┌─ HỘ CHIẾU TÍNH NĂNG ─────────────────────────────┐
│ 1. Chặng      : Ý tưởng / CAD-Sketch / CAD-Pro /  │
│                 Render / Present / Photo           │
│ 2. Bậc        : N / P / L                          │
...
> CAD → Render → Present**, IF chính thức **4 chặng (0→3)**, không phải chỉ 3 chặng như trước).
> Chi tiết ở `docs/SPEC-STAGE-0-IDEATION.md` — Duyệt 01/08/2026 (xem
> `CHOT-DUYET-SPEC-DOT2-2026-08-01.md`), nạp vào repo 26/07 tối (gói tài liệu đợt 4-11), chưa audit
> code (chưa có route/canvas nào build).

| Chặng | N (nền) | P (pro) | L (lai trội) | Việc phải làm trước |
|---|---|---|---|---|
| **0 · Ý tưởng** | ⬜ chưa build — spec `docs/SPEC-STAGE-0-IDEATION.md` duyệt hướng 01/08, xếp hàng đợi | — | — | V1 video + ĐỢT 3 `useDismissable` xong trước, không rút người khỏi việc đang chạy |
