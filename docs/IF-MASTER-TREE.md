# IF MASTER TREE — cây phân rã DUY NHẤT của toàn app

> **Vai trò file**: kim chỉ nam thay thế việc đọc 25 file spec rời. Gom MỌI tính năng đã từng
> được spec (18 file `SPEC-*.md` + `IF-ARCHITECTURE-BLUEPRINT-v1.md` + `IF-FEATURE-SPEC-P1-v2.md`
> + `IF-PRESENT-SPRINT-PLAN.md` + `IF1-COMPLETION-AUDIT.md` + `docs/PLAN-LIBRARY-GATEWAY.md`)
> thành 1 cây 4 cấp, đánh số, trạng thái căn cứ CODE THẬT — không tin lời spec.
>
